...
const skillSet = (quick, quickDamage, heavy, heavyDamage, tactical, tacticalDamage) => [
  { id:'quick', name:quick, damage:quickDamage, meterGain:30, questionLevel:'light', label:'基礎題', icon:'⌁' },
  { id:'heavy', name:heavy, damage:heavyDamage, meterGain:42, questionLevel:'heavy', label:'進階題', icon:'⚙' },
  { id:'tactical', name:tactical, damage:tacticalDamage, meterGain:52, questionLevel:'heavy', label:'戰術題', icon:'✹' },
];
const skillSets = {
...
function createFighter(profile, isCpu=false) { return { name:profile.name, icon:profile.icon, image:profile.image, health:100, meter:0, streak:0, isCpu, skills:skillSets[profile.id] || skillSet('掃描衝擊',8,'除錯連發',16,'同步戰術',22), ultimate:random(profile.ultimates?.length ? profile.ultimates : [{ name:'同步衝擊', damage:30, color:'#ffe479' }]) }; }
